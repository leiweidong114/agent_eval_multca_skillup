...
const route=useRoute(),loading=ref(false),detail=ref(null),results=ref([]),comparison=ref({}),error=ref(''),eventStream=ref(null),interactions=ref([]),interactionsLoaded=ref(false),openingFolder=ref(false),autoFollowEvents=ref(true)
let refreshTimer
