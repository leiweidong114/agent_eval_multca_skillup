...
class InfrastructureSettings:
    ...
    schematic_data_delete_path: str | None
...
def load_infrastructure_settings(*, force: bool = False) -> InfrastructureSettings:
    ...
    delete_path = str(environment.get("SCHEMATIC_DATA_DELETE_PATH") or "/schematic/schematicData/delete").strip()
    ...
    return InfrastructureSettings(
        ...
        schematic_data_delete_path=("/" + delete_path.lstrip("/")) if delete_path else None,
