...
def test_root_env_overrides_profile_model_gateway_and_key(tmp_path):
    _write_config(tmp_path)
    (tmp_path / ".env").write_text(
        """\
LITELLM_PROFILE=minimax
LITELLM_MODEL=MiniMax-M3-test
LITELLM_API_BASE=http://gateway.example:4100
